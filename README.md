...
Produces a polished, personalized interview invitation email based on:
...
The structured JSON email will appear in your terminal.
...
* 🔹 ATS-format exports (CSV, JSONL, PDF)
